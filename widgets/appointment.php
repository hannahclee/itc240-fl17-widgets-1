...
<?php
 ...
 //put client's email address here:  
   $to      = 'Hannah.Lee@seattlecolleges.edu';   
          ...
          <div class="row">
            ...
            <div class="clearfix"></div>
             ...
             <div class="form-group col-lg-4">
              ...
              <input type = "radio" name = "Appointment_Type" value = "Advanced Wheel Throwing"/>Advanced Wheel Throwing</p>
            ...
            <div class="form-group col-lg-4">
              ...
              <input type="text" name="Appointment_Date" class="form-control" required="required">
            </div>   
